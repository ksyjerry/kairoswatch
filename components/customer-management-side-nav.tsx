...
export default function CustomerManagementSideNav() {
  ...
  const menuItems = [
    {
      title: "고객 관리",
      items: [
        { label: "고객 등록", href: "/customer-management/registration", icon: <UserPlus size={16} /> },
        { label: "고객 조회", href: "/customer-management/inquiry", icon: <Search size={16} /> },
      ],
    },
  ]
  ...
  return (
    <div className="w-56 bg-white border-r border-[#dde0df] h-[calc(100vh-4rem)] fixed top-16 left-0 overflow-y-auto hidden md:block">
      <div className="p-3 border-b border-[#dde0df]">
        <h2 className="text-base font-medium text-[#1f1f1f]">고객 관리</h2>
      </div>
      <nav className="p-2">
